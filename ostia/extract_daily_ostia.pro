pro extract_daily_ostia                                       ;Nama filenya, Nama file harus sama dengan *.pro bila tidak sama akan Error
...
;===========================PATH_INTPUT=================================
path_input='D:\SKRIPSI\vault\data\ostia\'+year_st+'\'+month_st+'\'+year_st+month_st+day_st+'*.nc'  
...
;stop
NCDF_VARGET, cdfid, 0, time ;0 dihitung sebagai data pertama
NCDF_VARGET, cdfid, 1, lat       
NCDF_VARGET, cdfid, 2, lon
...
latmin=min(lat)
lonmin=min(lon)            
grid_interval=lon[1]-lon[0] ;0.050003052
...
data_map = sst_map[a:b,c:d] ;301 201
stop
;=========================================================
file_mkdir,'D:\SKRIPSI\database\ostia\extract dialy\'+year_st+'\'+month_st+'
save,data_map,filename='D:\SKRIPSI\database\ostia\extract dialy\'+year_st+'\'+month_st+'\sst'+year_st+month_st+day_st+'.sav' 
;stop
