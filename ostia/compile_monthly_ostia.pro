...
;=============masukin data==============
path_input='D:\SKRIPSI\database\ostia\extract dialy\'+year_st+'\'+month_st+'\sst'+year_st+month_st+'*.sav' 
;stop'  
...
;stop
file_mkdir, 'D:\SKRIPSI\database\ostia\compile monthly\'+year_st+'\'
path_output='D:\SKRIPSI\database\ostia\compile monthly\'+year_st+'\sst'+year_st+month_st+'.sav
